    ...
    <table>
        ...
        <c:forEach items="${posts}" var="post">
            <tr>
                ...
                <td><a href="/myWeb_war/xpostSelectServlet?pid=${post.pid}">查看</a>
                    <a href="./postSelectServlet?pid=${post.pid}" class="ownerOnly" style="display: none">修改</a>
...
<script>
    ...
    document.getElementById("updateInfo").onclick = function (){
        location.href = "/myWeb_war/infoSelectServlet?uid=${user.uid}"
    }
</script>
</body>
</html>
