...
@WebServlet("/xcommentSelectServlet")
public class xCommentSelectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Visit/replyWrite.jsp").forward(request, response);
    }
